...
! CVS: $Name: $
! 底物利用率最大为0.9,增加氮相关状态变量的变化速率的输出-20260429
!----------------------------------------------------------------------------
...
double precision :: growSP15nh4, growSP15no3, growSP15n,&
      ...
      u_nitrf, beta_nitrf, factor_nitrf
