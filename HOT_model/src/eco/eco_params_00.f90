...
!-------------------------------------------------------------------------
  integer, parameter :: iPP=1, iprBAc=2, &
				   ...
				   ipomMZc=128, ipomMZn=129, ipomMZp=130, &
				   iremvMZc=131, iremvMZn=132, iremvMZp=133, &
				   ipomHZc=134, ipomHZn=135, ipomHZp=136, &
				   iexcrHZsdomc=137, iexcrHZsdomn=138, iexcrHZsdomp=139, &
				   iremiHZn=140, iremiHZp=141, &
				   idisDETc=142, idisDETn=143, idisDETp=144, &
				   initrf=145, &
				  ! irefrSDOMc=149, irefrSDOMn=150, irefrSDOMp=151, &
				   iexportc=146,iexportn=147,iexportp=148 
...
!-------------------------------------------------------------------------
  integer, parameter :: numdiagvar=148
