...
!-------------------------------------------------------------------------
  integer, parameter :: iPP=1, iprBAc=2, &
				...
				initrf=167, iexportc=168, iexportn=169, iexportp=170, &
                                  ...
                                  igrowSP15n=232, igrowTR15n=233, igrowDDA15n=234,&
                                  igrowUN15n=235,&
                                  !===================================================== 
                                  ! 新增氮变化速率dydt相关的诊断通量
                                  !=====================================================
                                  idydt_SPn=236, idydt_TRn=237, idydt_DDAn=238, idydt_UNn=239, &
                                  idydt_BAn=240, idydt_PRTn=241, idydt_MZn=242, idydt_LDOMn=243, &
                                  idydt_SDOMn=244, idydt_DETn=245, idydt_NO3=246, idydt_NH4=247, &
                                  idydt_SP15n=248, idydt_TR15n=249, idydt_DDA15n=250, &
                                  idydt_UN15n=251, idydt_BA15n=252, idydt_PRT15n=253, &
                                  idydt_MZ15n=254, idydt_LDOM15n=255, idydt_SDOM15n=256, &
                                  idydt_DET15n=257, idydt_NO3_15=258, idydt_NH4_15=259
...
!-------------------------------------------------------------------------
  integer, parameter :: numdiagvar=259
