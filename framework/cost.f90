...
module cost
  ...
  integer, parameter, public :: ndat_max=5000 
  !ndat_max=3000
  ...
  ! xcdoc           semi-labile DOC Concentration (mmolC/m3) !Luo_MB
    integer, parameter, public :: xcnit=1,xcpo4=2,xczoo=3,xcphy=4,xcchl=5, &
                xcppr=6, xcbac=7,xcbpr=8,xcdoc=9,xcdon=10, xcdop=11, &
                xcpoc=12, xcpon=13,xcpon15=14,xcpop=15,xcnfr=16 !Luo_MB
  ...
  integer, parameter, public :: ncnsv=16 !Luo_MB
  
  integer, parameter, public :: xcstc=1,xcstn=2,xcstn15=3,xcstp=4
  integer, parameter, public :: ncnsv_sed=4
...
!       (a_csed(1:ndat_sed)-csed_pred(1:ndat_sed)))**2)
  ...
  !fcost=f_cost_sed/ndat_tot
   ...
   write(6,*)trim(dat_prefix_loc)//' '//'PON15 cost =', &
         sngl(f_cost(xcpon15)/ndat_tot) !Luo_MB
    write(6,*)trim(dat_prefix_loc)//' '//'POP cost =', &
         sngl(f_cost(xcpop)/ndat_tot) !Luo_MB
    write(6,*)trim(dat_prefix_loc)//' '//'NFR cost =', &
         sngl(f_cost(xcnfr)/ndat_tot) !Luo_MB
    ...
    write(6,*)trim(dat_prefix_loc)//' '//'STn15 cost =', &
         sngl(f_cost_sed(xcstn15)/ndat_tot)
